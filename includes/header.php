        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <ul class="navbar-nav flex-column mt-4">
                    ...
                    <li class="nav-item"><a href="marcas.php" class="nav-link text-white p-1 mb-2 sidebar-link">
                        <i class="fas fa-users text-light fa-lg mr-3"></i>Administracion de Marcas</a></li>    
                ...
                <!-- end sidebar-->
                <!-- top-nav-->
                <div class="col-xl-10 col-lg-9 col-md-9 ml-auto bg-success fixed-top py-2 top-navbar">
